class Project < ActiveRecord::Base
  ...
  attr_accessible :key, :name, :pivotal_token, :pivotal_project_id, :pivotal_project_name, :campfire_room, :campfire_subdomain, :campfire_token, :campfire_activate, :campfire_room_id, :point_scale, :default_velocity, :start_date, :iteration_start_day, :iteration_length
